...
metadata {
	...
	definition(name: "Tasmota RGBCW Bulb", namespace: "davindameron", author: "Davin Dameron", ocfDeviceType: "oic.d.light", mnmn:"SmartThings", vid:"generic-rgbw-color-bulb") {
		capability "Polling"
		capability "Refresh"
		capability "Switch"
...
def setColor(Map colorHSMap) {
	...
	def payload = "${boundedHue},${boundedSaturation},${switchLevel.level.value}";
