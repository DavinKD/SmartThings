metadata {
	...
	definition(name: "Tasmota Switch", namespace: "davindameron", author: "Davin Dameron", ocfDeviceType: "oic.d.switch", mnmn: "SmartThingsCommunity", vid: "a7df6312-e1c3-3105-902f-59692216362b") {
		capability "Polling"
		capability "Refresh"
		capability "Switch"
		capability "Execute"
