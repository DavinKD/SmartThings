metadata {
	definition(name: "Tasmota PH", namespace: "davindameron", author: "Davin Dameron", mnmn: "SmartThingsCommunity", vid: "74c51c23-11cc-3986-9442-d3e3a90305e0") {
	...
	tiles(scale: 2) {
        ...
        valueTile("pressure", "device.ph", width: 2, height: 2) {
