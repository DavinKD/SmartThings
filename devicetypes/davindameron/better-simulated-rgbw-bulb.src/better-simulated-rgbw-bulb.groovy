...
metadata {
	...
	definition(name: "Better Simulated RGBW Bulb", namespace: "davindameron", author: "Davin Dameron", ocfDeviceType: "oic.d.smartplug") {
		capability "Polling"
		capability "Refresh"
		capability "Switch"
	...
	main "switch"
		details(["switch", "refresh", "ringswitch", "rgbSelector", "colorTempSliderControl", "levelSliderControl"])
	}
