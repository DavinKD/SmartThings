...
metadata {
	...
	definition(name: "Tasmota RGBW Bulb", namespace: "davindameron", author: "Davin Dameron", ocfDeviceType: "oic.d.smartplug", mnmn:"SmartThings", vid:"generic-rgbw-color-bulb") {
		capability "Polling"
		capability "Refresh"
		capability "Switch"
