...
metadata {
	...
	definition(name: "Tasmota RGBW Bulb", namespace: "davindameron", author: "Davin Dameron", mnmn:"SmartThings", vid:"generic-rgbw-color-bulb") {
		capability "Polling"
		capability "Refresh"
		capability "Switch"
...
private List buildColorTempList(IntRange kRange, Integer kStep, List kExtras) {
    ...
    doLogging "color temp ranges"
    dologging kRange.getFrom()
    dologging kRange.getTo()
